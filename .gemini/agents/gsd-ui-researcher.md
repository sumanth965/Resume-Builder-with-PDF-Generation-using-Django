...
Use template from `D:/Documentsss/resume_project/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Documentsss/resume_project/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
