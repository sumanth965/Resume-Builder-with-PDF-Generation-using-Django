...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@D:/Documentsss/resume_project/.gemini/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
