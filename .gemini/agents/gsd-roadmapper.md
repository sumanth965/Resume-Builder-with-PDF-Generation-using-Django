...
Reference full template: `D:/Documentsss/resume_project/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Documentsss/resume_project/.gemini/get-shit-done/templates/state.md`.
