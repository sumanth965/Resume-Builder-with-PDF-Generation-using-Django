...
<required_reading>
@D:/Documentsss/resume_project/.gemini/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Documentsss/resume_project/.gemini
                  → checks D:/Documentsss/resume_project/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Documentsss/resume_project/.gemini/get-shit-done
                  → writes to D:/Documentsss/resume_project/.gemini/get-shit-done/hooks/
...
@D:/Documentsss/resume_project/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Documentsss/resume_project/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
