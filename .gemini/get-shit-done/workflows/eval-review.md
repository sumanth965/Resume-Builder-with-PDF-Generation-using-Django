...
```bash
AUDITOR_MODEL=$(node "D:/Documentsss/resume_project/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/Documentsss/resume_project/.gemini/agents/gsd-eval-auditor.md for instructions.
