...
<!-- For checkpoint task examples and patterns, see @D:/Documentsss/resume_project/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/Documentsss/resume_project/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Documentsss/resume_project/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Documentsss/resume_project/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
